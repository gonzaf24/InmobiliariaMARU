...
const Admin=({ className, testId, id }) => {
  ...
  return (
    ...
    >
      ...
      <NavLink to='/admin/users' className={styles.ItemLink}>{t(texts.AdminUsers)}</NavLink>
      <NavLink to='/admin/newFlat' className={styles.ItemLink}>{t(texts.RegisterNewFlat)}</NavLink>
    </div>
  );
};
